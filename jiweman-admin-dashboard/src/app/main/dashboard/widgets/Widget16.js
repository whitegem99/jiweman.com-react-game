...
import * as Actions from '../store/actions/country_graph.actions';
...
function Widget16(props) {
    ...
    useEffect(() => { 
        dispatch(Actions.getCountryGraphData())
    }, [])
	...
	return (
		<Paper className="w-full rounded-8 shadow-none border-1">
            ...
            <FilterDialog title='Country Filter' open={open} toggleDialog={toggleDialog} getFilteredData={Actions.getCountryGraphData} />
		</Paper>
	);
}
