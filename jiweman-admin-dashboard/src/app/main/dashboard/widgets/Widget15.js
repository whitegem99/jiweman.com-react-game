...
import * as Actions from '../store/actions/gender_graph.actions';
...
function Widget15(props) {
    ...
    useEffect(() => {
        dispatch(Actions.getGenderGraphData())
     }, [])
	...
	return (
		<Paper className="w-full rounded-8 shadow-none border-1">
            ...
            <FilterDialog title='Gender Filter' open={open} toggleDialog={toggleDialog} getFilteredData={Actions.getGenderGraphData} />
		</Paper>
	);
}
