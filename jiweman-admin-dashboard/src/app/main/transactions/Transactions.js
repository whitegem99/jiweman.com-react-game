...
function TransactionsPage(props) {
	...
	useEffect(() => {
		dispatch(Actions.getTransactions({ page: 0, limit: 10 }));
	}, [dispatch]);
	...
	function handlePageChange(limit, page) {
		dispatch(Actions.getTransactions({ limit, page }));
	}
							...
							<div className="flex flex-1 flex-col min-w-0">
								<FuseAnimate delay={600}>
									<div className="flex justify-between flex-row min-w-0 p-16 pb-8">
										<Typography className=" text-18 font-300">List of your transactions</Typography>
...
export default withReducer('transactionsPage', reducer)(TransactionsPage);
